...
export { User, IUser, SubscriptionStatus, AvatarType } from './user.model';
export { Otp, IOtp, OtpType } from './otp.model';
export { RefreshToken, IRefreshToken } from './refreshToken.model';
export { ExamResult, IExamResult, ExamMode, ISubjectResult } from './examResult.model';
